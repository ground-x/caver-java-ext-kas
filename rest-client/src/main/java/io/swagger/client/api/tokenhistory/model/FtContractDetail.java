...
public class FtContractDetail {
   ...
   * @return address
  **/
  @ApiModelProperty(example = "9.881401532163391E47", required = true, value = "컨트랙트 주소 (20-byte)")
  ...
  **/
   ...
   * @return symbol
  **/
  @ApiModelProperty(example = "TSC", required = true, value = "토큰 심볼")
  ...
  **/
   ...
   * @return type
  **/
  @ApiModelProperty(required = true, value = "컨트랙트 유형 (kip, erc)")
