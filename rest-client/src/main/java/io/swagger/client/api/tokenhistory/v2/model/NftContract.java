...
public class NftContract {
  ...
  **/
   ...
   * @return name
  **/
  @ApiModelProperty(example = "Test contract", required = true, value = "NFT name")
   ...
   * @return symbol
  **/
  @ApiModelProperty(example = "TSTC", required = true, value = "NFT symbol")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(address, name, symbol);
  }
