...
public class Account {
  ...
  **/
   ...
   * @return createdAt
  **/
  @Schema(example = "1599187293", required = true, description = "클레이튼 계정 생성 시간")
   ...
   * @return keyId
  **/
  @Schema(example = "krn:1001:wallet:68ec0e4b-0f61-4e6f-ae35-be865ab23187:account-pool:default:0x4cbbcb974e32a7960e1b356edf60087613101919ed83199f12e872cba068a50f", required = true, description = "해당 계정의 개인키 ID")
  ...
  **/
   ...
   * @return publicKey
  **/
  @Schema(example = "0x04cdccfb99b2905561e3dd886687b429a004718f11b04914f17ce68fd3a0db46c598a45da85caa61fe84cb78a0f2eaa9983ec7b8805a93ef9428eb1350a8558237", required = true, description = "해당 계정의 공개키")
   ...
   * @return updatedAt
  **/
  @Schema(example = "1599187293", required = true, description = "해당 계정 정보를 마지막으로 업데이트한 시간")
  ...
  **/
   ...
   * @return threshold
  **/
  @Schema(example = "4", description = "다중 서명 트랜잭션을 생성하는 데 필요한 가중치 합계 기준값.")
