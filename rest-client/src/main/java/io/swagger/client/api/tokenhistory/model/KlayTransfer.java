...
public class KlayTransfer {
  ...
  **/
  @ApiModelProperty(example = "8.894164055280364E76", required = true, value = "트랜잭션 해시")
  ...
  **/
  @ApiModelProperty(example = "1", required = true, value = "트랜잭션 인덱스")
   ...
   * @return transferType
  **/
  @ApiModelProperty(example = "klay", required = true, value = "거래내역 유형")
   ...
   * @return typeInt
  **/
  @ApiModelProperty(example = "50", required = true, value = "트랜잭션 유형")
