...
public class NftOwnershipChange {
   ...
   * @return from
  **/
  @ApiModelProperty(example = "5.3824395526049505E47", required = true, value = "보낸 사람 (직전 소유자) EOA 주소 (20-byte)")
   ...
   * @return to
  **/
  @ApiModelProperty(example = "1.0318861629967498E48", required = true, value = "받은 사람 (이 시점의 소유자) EOA 주소 (20-byte)")
  public String getTo() {
    return to;
  }
