...
public class MultisigAccount {
   ...
   * @return address
  **/
  @Schema(example = "0xa809284C83b901eD106Aba4Ccda14628Af128e14", description = "클레이튼 계정주소")
   ...
   * @return krn
  **/
  @Schema(example = "krn:1001:wallet:68ec0e4b-0f61-4e6f-ae35-be865ab23187:account-pool:default", description = "KAS KRN")
  ...
  **/
   ...
   * @return updatedAt
  **/
  @Schema(example = "1599187391", description = "해당 계정 정보를 마지막으로 업데이트한 시간")
  ...
  public MultisigAccount weight(Long weight) {
    this.weight = weight;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.address, multisigAccount.address) &&
        ...
        Objects.equals(this.weight, multisigAccount.weight);
  }

  @Override
  public int hashCode() {
    return Objects.hash(address, krn, multiSigKeys, threshold, transactionHash, updatedAt, weight);
  }
