...
public class InvalidQueryParameterValue {
  ...
  public InvalidQueryParameterValue code(Integer code) {
    this.code = code;
    return this;
  }
   ...
   * @return code
  **/
  @ApiModelProperty(example = "1040010", value = "")
   ...
   * @return message
  **/
  @ApiModelProperty(example = "[InvalidQueryParameterValue]required presets", value = "")
