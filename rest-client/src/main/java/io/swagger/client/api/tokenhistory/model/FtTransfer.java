...
public class FtTransfer {
  ...
  **/
  @ApiModelProperty(example = "2.0E-18", required = true, value = "decimal을 적용한 변환값")
  ...
  **/
   ...
   * @return transferType
  **/
  @ApiModelProperty(example = "ft", required = true, value = "거래내역 유형")
   ...
   * @return value
  **/
  @ApiModelProperty(example = "10", required = true, value = "전송한 토큰 개수 (16진수)")
