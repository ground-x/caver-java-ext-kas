...
public class AccountKey {
  ...
  @SerializedName("key")
  private List<KeyObj> key = null;

  public AccountKey keyType(Long keyType) {
  ...
  **/
  ...
  public AccountKey key(List<KeyObj> key) {
    this.key = key;
    return this;
  }

  public AccountKey addKeyItem(KeyObj keyItem) {
    if (this.key == null) {
      this.key = new ArrayList<KeyObj>();
    }
  ...
  **/
  @Schema(description = "")
  public List<KeyObj> getKey() {
    return key;
  }

  public void setKey(List<KeyObj> key) {
    this.key = key;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.keyType, accountKey.keyType) &&
        Objects.equals(this.key, accountKey.key);
  }
