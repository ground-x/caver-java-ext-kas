...
public class PageableTransfers {
  ...
  public PageableTransfers items(List<Item> items) {
    this.items = items;
    return this;
  }

  public PageableTransfers addItemsItem(Item itemsItem) {
  ...
  **/
  ...
  public PageableTransfers nextCursor(String nextCursor) {
   ...
   * @return nextCursor
  **/
  @ApiModelProperty(example = "z2o87adeLbW4Aqm53gpq6VbGZg3JmE5vodrwD9XKmY5vMl4Gkw9PZO1NoBpV8LR83y0Edb3Aar7eKQqzJWDg6X2xOe1P27l4kzY0xQa8LNABMWv0VJQ6MpNlr9O1xBDE", required = true, value = "Next cursor")
  ...
  public boolean equals(Object o) {
    ...
    PageableTransfers pageableTransfers = (PageableTransfers) o;
    return Objects.equals(this.items, pageableTransfers.items) &&
        Objects.equals(this.nextCursor, pageableTransfers.nextCursor);
  }
  ...
  public String toString() {
    ...
    sb.append("class PageableTransfers {\n");
