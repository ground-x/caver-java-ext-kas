...
public class NftContract {
  ...
  **/
   ...
   * @return name
  **/
  @ApiModelProperty(example = "Test contract", required = true, value = "토큰 이름")
  ...
  **/
   ...
   * @return status
  **/
  @ApiModelProperty(example = "completed", value = "컨트랙트 라벨링 상태 (completed, processing, failed, cancelled)")
