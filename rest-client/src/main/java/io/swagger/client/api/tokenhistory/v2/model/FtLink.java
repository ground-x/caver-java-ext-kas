...
public class FtLink {
  ...
  public FtLink website(String website) {
   ...
   /**
   * URL to a FT owner website
   * @return website
  **/
  @ApiModelProperty(example = "https://link.to/ft", required = true, value = "URL to a FT owner website")
   ...
   * @return icon
  **/
  @ApiModelProperty(example = "https://link.to/ft/icon.png", required = true, value = "URL to a FT icon")
