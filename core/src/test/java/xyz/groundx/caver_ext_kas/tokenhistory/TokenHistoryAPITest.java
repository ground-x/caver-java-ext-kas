...
package xyz.groundx.caver_ext_kas.tokenhistory;
...
public class TokenHistoryAPITest {
    ...
    public void getTransferHistoryWithSize() {
        try {
            ...
            assertNotNull(transfersData.getItems());
            assertEquals(3, transfersData.getItems().size());
        } catch (ApiException e) {
            e.printStackTrace();
            fail();
        }
    ...
    public void getTransferHistoryInvalidPreset() {
        try {
            ...
            assertEquals(1040400, res.getCode().longValue());
        }
    }
    ...
    public void getNFTListWithSize() {
        ...
        try {
            ...
            assertNotNull(nfts);
            assertEquals(3, nfts.getItems().size());
        } catch (ApiException e) {
            e.printStackTrace();
            fail();
        }
    ...
    public void getNFTOwnershipHistoryWithSize() {
        ...
        try {
            ...
            assertNotNull(ownershipChanges);
            assertEquals(1, ownershipChanges.getItems().size());
        } catch (ApiException e) {
            e.printStackTrace();
            fail();
        }
