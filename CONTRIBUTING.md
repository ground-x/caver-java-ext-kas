...
Thank you for your interest in contributing to caver-java-ext-kas. As an open source project, caver-java-ext-kas is always open to the developer community and we welcome your contribution. Please read the guideline below and follow it in all interactions with the project.
...
If you find a bug or other issues in caver-java, please [submit an issue](https://github.com/ground-x/caver-java-ext-kas/issues). Before submitting an issue, please invest some extra time to figure out that:
...
After confirming your report meets the above criteria, [submit the issue](https://github.com/ground-x/caver-java-ext-kas/issues). Please use [labels](#usage-of-labels) to categorize your issue.

### Feature Requests

You can also use the [issue tracker](https://github.com/ground-x/caver-java-ext-kas/issues) to request a new feature or enhancement. Note that any code contribution without an issue link will not be accepted. Please submit an issue explaining your proposal first so that Klaytn community can fully understand and discuss the idea. Please use [labels](#usage-of-labels) for your feature request as well.
...
Keep in mind when you submit your pull request, you'll need to sign the CLA via [CLA-Assistant](https://cla-assistant.io/ground-x/caver-java-ext-kas) for legal purposes. You will have to sign the CLA just one time, either as an individual or corporation.
