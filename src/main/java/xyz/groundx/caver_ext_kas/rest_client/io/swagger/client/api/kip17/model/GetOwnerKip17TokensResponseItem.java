...
public class GetOwnerKip17TokensResponseItem {
  ...
  public GetOwnerKip17TokensResponseItem createdAt(Long createdAt) {
   ...
   * @return createdAt
  **/
  @Schema(example = "1608691873", required = true, description = "The UNIX timestamp of when the token was minted.")
  ...
  public GetOwnerKip17TokensResponseItem owner(String owner) {
    this.owner = owner;
    return this;
  }
   ...
   * @return owner
  **/
  @Schema(example = "905926021062573029082840825013416120695539447028", required = true, description = "The Klaytn account address of the current owner.")
  ...
  public GetOwnerKip17TokensResponseItem previousOwner(String previousOwner) {
  ...
  **/
  ...
  public GetOwnerKip17TokensResponseItem tokenId(String tokenId) {
   ...
   * @return tokenId
  **/
  @Schema(example = "19", required = true, description = "The ID assigned to the token.")
  ...
  public GetOwnerKip17TokensResponseItem tokenUri(String tokenUri) {
   ...
   * @return tokenUri
  **/
  @Schema(example = "https://metastore.kip17.com/0xbe02aba/0x1", required = true, description = "The URI that contains the token's metadata.")
  ...
  public GetOwnerKip17TokensResponseItem transactionHash(String transactionHash) {
  ...
  **/
  @Schema(example = "27124749996344194085696793942109724590930580320113064658404917111103605739856", required = true, description = "")
  ...
  public GetOwnerKip17TokensResponseItem updatedAt(Long updatedAt) {
   ...
   * @return updatedAt
  **/
  @Schema(example = "1608691873", required = true, description = "The UNIX timestamp of the last token ownership change.")
  ...
  public boolean equals(Object o) {
    ...
    GetOwnerKip17TokensResponseItem getOwnerKip17TokensResponseItem = (GetOwnerKip17TokensResponseItem) o;
    return Objects.equals(this.createdAt, getOwnerKip17TokensResponseItem.createdAt) &&
        Objects.equals(this.owner, getOwnerKip17TokensResponseItem.owner) &&
        Objects.equals(this.previousOwner, getOwnerKip17TokensResponseItem.previousOwner) &&
        Objects.equals(this.tokenId, getOwnerKip17TokensResponseItem.tokenId) &&
        Objects.equals(this.tokenUri, getOwnerKip17TokensResponseItem.tokenUri) &&
        Objects.equals(this.transactionHash, getOwnerKip17TokensResponseItem.transactionHash) &&
        Objects.equals(this.updatedAt, getOwnerKip17TokensResponseItem.updatedAt);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetOwnerKip17TokensResponseItem {\n");
