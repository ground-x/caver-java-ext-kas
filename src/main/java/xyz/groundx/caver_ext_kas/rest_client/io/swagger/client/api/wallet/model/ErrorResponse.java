...
public class ErrorResponse {
   ...
   * @return code
  **/
  @Schema(example = "1061615", description = "")
  public Long getCode() {
    return code;
  }
   ...
   * @return message
  **/
  @Schema(example = "its value is out of range; size", description = "")
   ...
   * @return requestId
  **/
  @Schema(example = "POST-/v2/registration/account-1607566714428099800", description = "")
