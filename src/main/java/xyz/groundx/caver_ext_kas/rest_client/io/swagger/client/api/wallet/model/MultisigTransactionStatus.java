...
public class MultisigTransactionStatus {
  ...
  **/
   ...
   * @return signedWeight
  **/
  @Schema(example = "1", required = true, description = "Sum of weight after this signer signed")
   ...
   * @return status
  **/
  @Schema(example = "Signed", required = true, description = "Current transaction status")
  ...
  **/
   ...
   * @return weight
  **/
  @Schema(example = "1", required = true, description = "Weight of this signer")
