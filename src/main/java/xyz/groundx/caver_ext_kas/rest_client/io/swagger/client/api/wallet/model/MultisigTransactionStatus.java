...
public class MultisigTransactionStatus {
   ...
   * @return signedWeight
  **/
  @Schema(example = "4", required = true, description = "해당 트랜잭션이 서명을 받았을 때, 그 서명들이 가지는 가중치")
   ...
   * @return status
  **/
  @Schema(example = "Submitted", required = true, description = "트랜잭션의 현재 상태")
  ...
  **/
   ...
   * @return weight
  **/
  @Schema(example = "3", required = true, description = "해당 서명자의 가중치 값")
