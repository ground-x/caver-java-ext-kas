 ...
 */
@Schema(description = "Anchor transaction request schema")
...
public class AnchorTransactionRequest {
   ...
   * @return from
  **/
  @Schema(example = "0xA409364039Ab69B0EdD72F96Bd926E9AAbaF7DA4", required = true, description = "Klaytn transaction address to send transaction")
