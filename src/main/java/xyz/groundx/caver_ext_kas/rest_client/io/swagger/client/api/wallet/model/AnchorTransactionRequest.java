...
public class AnchorTransactionRequest {
   ...
   * @return from
  **/
  @Schema(example = "936479919040064277769212734096556640071398161828", required = true, description = "Klaytn transaction address to send transaction")
   ...
   * @return input
  **/
  @Schema(example = "291", required = true, description = "Data that is attached to the transaction. Here, it is the data that is being anchored to the main chain.")
