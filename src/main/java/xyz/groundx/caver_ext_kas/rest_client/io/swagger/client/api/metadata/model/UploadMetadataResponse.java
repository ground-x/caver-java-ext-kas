...
public class UploadMetadataResponse {
  ...
  public UploadMetadataResponse filename(String filename) {
   ...
   * @return filename
  **/
  @Schema(description = "File name of the metadata")
  ...
  public UploadMetadataResponse contentType(String contentType) {
   ...
   * @return contentType
  **/
  @Schema(description = "Content type of the metadata")
  ...
  public UploadMetadataResponse uri(String uri) {
    this.uri = uri;
    return this;
  }
   ...
   * @return uri
  **/
  @Schema(description = "Externally accessible URI of the metadata")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    UploadMetadataResponse uploadMetadataResponse = (UploadMetadataResponse) o;
    return Objects.equals(this.filename, uploadMetadataResponse.filename) &&
        Objects.equals(this.contentType, uploadMetadataResponse.contentType) &&
        Objects.equals(this.uri, uploadMetadataResponse.uri);
  }

  @Override
  public int hashCode() {
    return Objects.hash(filename, contentType, uri);
  }
  ...
  public String toString() {
    ...
    sb.append("class UploadMetadataResponse {\n");
