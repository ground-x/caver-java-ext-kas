 ...
 */
@Schema(description = "Contract execution transaction request schema.")
...
public class ContractExecutionTransactionRequest {
   ...
   * @return from
  **/
  @Schema(example = "0x60d0902c428D0E197F97a756011Fd4893C1E57B0", required = true, description = "Klaytn account address to send transaction")
  ...
  **/
   ...
   * @return to
  **/
  @Schema(example = "0xabcd", required = true, description = "Contract address")
  public String getTo() {
    return to;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.from, contractExecutionTransactionRequest.from) &&
        Objects.equals(this.value, contractExecutionTransactionRequest.value) &&
        Objects.equals(this.to, contractExecutionTransactionRequest.to) &&
        Objects.equals(this.input, contractExecutionTransactionRequest.input) &&
        Objects.equals(this.nonce, contractExecutionTransactionRequest.nonce) &&
        Objects.equals(this.gas, contractExecutionTransactionRequest.gas) &&
        Objects.equals(this.submit, contractExecutionTransactionRequest.submit);
  }

  @Override
  public int hashCode() {
    return Objects.hash(from, value, to, input, nonce, gas, submit);
  }
