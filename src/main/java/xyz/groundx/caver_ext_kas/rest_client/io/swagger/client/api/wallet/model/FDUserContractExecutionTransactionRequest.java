...
public class FDUserContractExecutionTransactionRequest {
  ...
  **/
   ...
   * @return to
  **/
  @Schema(example = "0x0e8a2e471b40ff8916d8524a52989b65908f5671", required = true, description = "Contract address")
  public String getTo() {
    return to;
  }
   ...
   * @return input
  **/
  @Schema(example = "0x123", required = true, description = "Data that is sent along with the transaction and is used for execution.")
