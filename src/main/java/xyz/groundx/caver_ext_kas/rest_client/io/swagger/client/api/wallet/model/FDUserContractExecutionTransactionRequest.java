 ...
 */
@Schema(description = "User Fee Delegation Contract Execution Transaction Request Scheme")
...
public class FDUserContractExecutionTransactionRequest {
  ...
  **/
   ...
   * @return feeRatio
  **/
  @Schema(example = "38", description = "Ratio to be paid by the Proxy fee payer for the entire transaction fee(1~99). If value is empty or 0, fee payer will pay all fees")
