...
public class FDProcessRLPRequest {
   ...
   * @return rlp
  **/
  @Schema(required = true, description = "RLP 값으로 Klaytn RLP 포맷인 SigRLP 또는 TxHashRLP을 받으며, (partial) fee delegation 트랜잭션 타입만 허용함.")
  ...
  **/
   ...
   * @return feeRatio
  **/
  @Schema(example = "5", description = "전체 트랜잭션 수수료에서 수수료 대납자가 대납할 수수료의 비율")
