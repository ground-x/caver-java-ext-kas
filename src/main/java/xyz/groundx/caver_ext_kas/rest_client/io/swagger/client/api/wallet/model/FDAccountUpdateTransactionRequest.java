 ...
 */
@Schema(description = "Fee Delegation Account Update Transaction Request Scheme")
...
public class FDAccountUpdateTransactionRequest {
  ...
  **/
   ...
   * @return feeRatio
  **/
  @Schema(example = "70", description = "Ratio to be paid by the Proxy fee payer for the entire transaction fee(1~99). If value is empty or 0, fee payer will pay all fees")
