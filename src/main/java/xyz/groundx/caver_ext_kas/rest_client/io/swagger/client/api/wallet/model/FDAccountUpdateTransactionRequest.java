...
public class FDAccountUpdateTransactionRequest {
  ...
  private OneOfFDAccountUpdateTransactionRequestAccountKey accountKey = null;
   ...
   * @return from
  **/
  @Schema(example = "994124664268973710585145079290595742188554718602", required = true, description = "Klaytn transaction address to send transaction")
  ...
  public FDAccountUpdateTransactionRequest accountKey(OneOfFDAccountUpdateTransactionRequestAccountKey accountKey) {
  ...
  **/
  @Schema(description = "")
  public OneOfFDAccountUpdateTransactionRequestAccountKey getAccountKey() {
    return accountKey;
  }

  public void setAccountKey(OneOfFDAccountUpdateTransactionRequestAccountKey accountKey) {
    this.accountKey = accountKey;
  }
