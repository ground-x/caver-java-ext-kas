...
public class TransferKip17TokenRequest {
   ...
   * @return sender
  **/
  @Schema(example = "905926021062573029082840825013416120695539447028", required = true, description = "The Klaytn account address of the sender.")
  ...
  **/
   ...
   * @return to
  **/
  @Schema(example = "1256858690287786827422183071797137826454416580167", required = true, description = "The Klaytn account address of the recipient.")
  public String getTo() {
    return to;
  }
