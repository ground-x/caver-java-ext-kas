...
public class KeySignDataRequest {
   ...
   * @return data
  **/
  @Schema(example = "110377339960434676134795058538644347414156471738218880683626129191467747266461", required = true, description = "Data to be signed. Limited to 32 bytes")
