...
public class FDContractDeployTransactionRequest {
   ...
   * @return from
  **/
  @Schema(example = "75441380562264539877000495430767807922364039937", required = true, description = "Klaytn transaction address to send transaction")
   ...
   * @return value
  **/
  @Schema(example = "1", description = "KLAY converted into PEB")
