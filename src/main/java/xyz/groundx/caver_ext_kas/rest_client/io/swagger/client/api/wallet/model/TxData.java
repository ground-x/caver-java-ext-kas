 ...
 */
@Schema(description = "Pratical transaction data of multisig transaction")
...
public class TxData {
   ...
   * @return from
  **/
  @Schema(example = "0xc6c9356887b7f7887918bf577417e5d8de253295", required = true, description = "Multisig account address")
  ...
  **/
   ...
   * @return gasPrice
  **/
  @Schema(example = "0x5d21dba00", required = true, description = "Transaction fee (gas) for sending the transaction")
  ...
  **/
   ...
   * @return to
  **/
  @Schema(example = "0x2f87ba64de5526f7880f21481effbf950f70005c", description = "Klaytn account address to receive KLAY or contract address")
  public String getTo() {
    return to;
  }
   ...
   * @return typeInt
  **/
  @Schema(example = "16", required = true, description = "Numeric value of transaction type")
   ...
   * @return value
  **/
  @Schema(example = "0x1001", description = "Amount of balance to transfer of this transaction")
