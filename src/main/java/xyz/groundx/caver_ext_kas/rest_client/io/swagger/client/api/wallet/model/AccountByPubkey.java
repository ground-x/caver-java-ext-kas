 ...
 */
@Schema(description = "Account associated with the requested public key")
...
public class AccountByPubkey {
  ...
  public AccountByPubkey address(String address) {
   ...
   * @return address
  **/
  @Schema(example = "0x0b7caaf70e7A0a5399041c64711E535CE8B3cf7d", required = true, description = "Klaytn account address")
  ...
  public AccountByPubkey chainId(Long chainId) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    AccountByPubkey accountByPubkey = (AccountByPubkey) o;
    return Objects.equals(this.address, accountByPubkey.address) &&
        Objects.equals(this.chainId, accountByPubkey.chainId);
  }
