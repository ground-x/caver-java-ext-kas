...
public class MultisigKey {
   ...
   * @return publicKey
  **/
  @Schema(example = "0x04c8901b732a08330d4b7a3d95841e82450f67ae290dadaf8941886913693a15c1819c7401768dea360b96fe02dca34db78d433c6ef4802a0866f4aa3b222f1d7e", required = true, description = "Public key of Klaytn account")
   ...
   * @return weight
  **/
  @Schema(example = "3", required = true, description = "Weight of public key")
