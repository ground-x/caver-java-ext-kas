...
import xyz.groundx.caver_ext_kas.rest_client.io.swagger.client.api.wallet.model.AccountByPubkey;
/**
 * List of accounts with the public key.
 */
@Schema(description = "List of accounts with the public key.")

public class AccountsByPubkey {
  @SerializedName("items")
  private List<AccountByPubkey> items = null;

  public AccountsByPubkey items(List<AccountByPubkey> items) {
    this.items = items;
    return this;
  }

  public AccountsByPubkey addItemsItem(AccountByPubkey itemsItem) {
    if (this.items == null) {
      this.items = new ArrayList<AccountByPubkey>();
    }
  ...
  **/
  @Schema(description = "")
  public List<AccountByPubkey> getItems() {
    return items;
  }

  public void setItems(List<AccountByPubkey> items) {
    this.items = items;
  }
  ...
  public boolean equals(Object o) {
    ...
    AccountsByPubkey accountsByPubkey = (AccountsByPubkey) o;
    return Objects.equals(this.items, accountsByPubkey.items);
  }
  ...
  public String toString() {
    ...
    sb.append("class AccountsByPubkey {\n");
