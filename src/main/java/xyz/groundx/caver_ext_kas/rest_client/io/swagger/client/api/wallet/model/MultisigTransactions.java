...
import xyz.groundx.caver_ext_kas.rest_client.io.swagger.client.api.wallet.model.PendedTransaction;
/**
...
public class MultisigTransactions {
   ...
   * @return cursor
  **/
  @Schema(required = true, description = "Information about the last cursor")
  ...
  public MultisigTransactions addItemsItem(PendedTransaction itemsItem) {
    if (this.items == null) {
      this.items = new ArrayList<PendedTransaction>();
    }
  ...
  **/
  @Schema(description = "")
  public List<PendedTransaction> getItems() {
    return items;
  }

  public void setItems(List<PendedTransaction> items) {
    this.items = items;
  }
