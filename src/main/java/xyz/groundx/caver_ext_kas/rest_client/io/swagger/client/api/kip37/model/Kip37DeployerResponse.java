...
public class Kip37DeployerResponse {
  ...
  public Kip37DeployerResponse address(String address) {
   ...
   * @return address
  **/
  @Schema(required = true, description = "The default Klaytn account address for contract management")
  ...
  public Kip37DeployerResponse krn(String krn) {
    this.krn = krn;
    return this;
  }
   ...
   * @return krn
  **/
  @Schema(required = true, description = "KRN of the account")
  ...
  public boolean equals(Object o) {
    ...
    Kip37DeployerResponse kip37DeployerResponse = (Kip37DeployerResponse) o;
    return Objects.equals(this.address, kip37DeployerResponse.address) &&
        Objects.equals(this.krn, kip37DeployerResponse.krn);
  }
  ...
  public String toString() {
    ...
    sb.append("class Kip37DeployerResponse {\n");
