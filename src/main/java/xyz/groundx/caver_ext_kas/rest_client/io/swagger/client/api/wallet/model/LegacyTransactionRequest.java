 ...
 */
@Schema(description = "Legacy Transaction Request Scheme")
...
public class LegacyTransactionRequest {
   ...
   * @return from
  **/
  @Schema(required = true, description = "Klaytn account address sending a transaction")
  ...
  **/
   ...
   * @return to
  **/
  @Schema(example = "0x5bb85d4032354E88020595AFAFC081C24098202e", description = "Klaytn account address to receive KLAY")
  public String getTo() {
    return to;
  }
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(from, value, to, nonce, gas, submit, input);
  }
