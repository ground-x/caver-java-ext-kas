...
public class BurnKip7TokenRequest {
   ...
   * @return from
  **/
  @Schema(example = "175224902929872758239811531255736711146941009517", description = "The Klaytn account address whose tokens will be burned. The default value is the `deployer`'s address'.`")
   ...
   * @return amount
  **/
  @Schema(example = "not hex string", required = true, description = "The amount of tokens to burn (in hex.)")
