...
public class ApproveKip7TokenRequest {
   ...
   * @return owner
  **/
  @Schema(example = "175224902929872758239811531255736711146941009517", description = "The Klaytn account address to grant the authority. The default value is the `deployer`'s address'.")
   ...
   * @return spender
  **/
  @Schema(example = "905926021062573029082840825013416120695539447028", required = true, description = "The Klaytn account address to be granted authority.")
   ...
   * @return amount
  **/
  @Schema(example = "1474", required = true, description = "Approved token amount (in hex.)")
