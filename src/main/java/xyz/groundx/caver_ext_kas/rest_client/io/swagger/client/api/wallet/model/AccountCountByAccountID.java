 ...
 */
@Schema(description = "Number of Klaytn accounts and keys on the KAS account")
...
public class AccountCountByAccountID {
  ...
  public AccountCountByAccountID accountId(String accountId) {
  ...
  **/
  ...
  public AccountCountByAccountID count(Long count) {
    this.count = count;
    return this;
  }
   ...
   * @return count
  **/
  @Schema(example = "1", required = true, description = "Number of Klaytn accounts and keys on the KAS account")
  ...
  public boolean equals(Object o) {
    ...
    AccountCountByAccountID accountCountByAccountID = (AccountCountByAccountID) o;
    return Objects.equals(this.accountId, accountCountByAccountID.accountId) &&
        Objects.equals(this.count, accountCountByAccountID.count);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accountId, count);
  }
