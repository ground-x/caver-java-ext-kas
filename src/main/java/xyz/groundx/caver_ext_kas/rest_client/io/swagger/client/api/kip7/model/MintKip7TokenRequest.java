...
public class MintKip7TokenRequest {
  ...
  public MintKip7TokenRequest from(String from) {
    this.from = from;
    return this;
  }
   ...
   * @return from
  **/
  @Schema(example = "not-eoa", description = "The Klaytn account address to mint the tokens. The default value is the `deployer`'s account.")
   ...
   * @return to
  **/
  @Schema(example = "not-eoa", required = true, description = "The Klaytn account address to receive the new tokens.")
  public String getTo() {
    return to;
  }
   ...
   * @return amount
  **/
  @Schema(example = "16", required = true, description = "The amount of tokens to create (in hexadecimal)")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.from, mintKip7TokenRequest.from) &&
        Objects.equals(this.to, mintKip7TokenRequest.to) &&
