 ...
 */
@Schema(description = "Multisig-associated account")
...
public class MultisigAddress {
   ...
   * @return address
  **/
  @Schema(example = "0xc6C9356887b7F7887918Bf577417E5D8De253295", required = true, description = "Multisig associated account address")
   ...
   * @return weight
  **/
  @Schema(example = "3", required = true, description = "Weight of Multisig associated account")
