 ...
 */
@Schema(description = "User Fee Delegation KLAY Transfer Transaction Request Scheme")
...
public class FDUserValueTransferTransactionRequest {
  ...
  **/
   ...
   * @return value
  **/
  @Schema(example = "0x12", required = true, description = "KLAY converted into PEB unit")
   ...
   * @return to
  **/
  @Schema(example = "0x2F87Ba64de5526F7880F21481Effbf950f70005c", required = true, description = "Klaytn account address to receive KLAY")
  public String getTo() {
    return to;
  }
