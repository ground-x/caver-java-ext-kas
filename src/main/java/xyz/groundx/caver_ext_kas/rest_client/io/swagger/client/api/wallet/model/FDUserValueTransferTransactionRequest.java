 ...
 */
@Schema(description = "User Fee Delegation KLAY transfer transaction request schema")
...
public class FDUserValueTransferTransactionRequest {
  ...
  **/
  ...
  public FDUserValueTransferTransactionRequest value(String value) {
    this.value = value;
    return this;
  }
   ...
   * @return value
  **/
  @Schema(example = "0x0", required = true, description = "KLAY converted into PEB")
  ...
  public FDUserValueTransferTransactionRequest to(String to) {
    this.to = to;
    return this;
  }
   ...
   * @return to
  **/
  @Schema(example = "0x5053e2f0dDe795c423A2b7f551C873f6Ef6F4Daa", required = true, description = "KLAY receiver's Klaytn account address")
  public String getTo() {
    return to;
  }
  ...
  public FDUserValueTransferTransactionRequest memo(String memo) {
    this.memo = memo;
    return this;
  }
   ...
   * @return memo
  **/
  @Schema(example = "0x123", description = "Memo to be attached to the transaction.")
  ...
  **/
  ...
  public FDUserValueTransferTransactionRequest feePayer(String feePayer) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    FDUserValueTransferTransactionRequest fdUserValueTransferTransactionRequest = (FDUserValueTransferTransactionRequest) o;
    return Objects.equals(this.from, fdUserValueTransferTransactionRequest.from) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(from, value, to, memo, nonce, gas, submit, feePayer, feeRatio);
  }
  ...
  public String toString() {
    ...
    sb.append("class FDUserValueTransferTransactionRequest {\n");
