...
//    @Test
//    public void valueTransfer() throws Exception {
//        BigInteger value = new BigInteger(Utils.convertToPeb("1", Utils.KlayUnit.mKLAY));
//
//        ValueTransfer valueTransfer = new ValueTransfer.Builder()
//                .setKlaytnCall(caver.rpc.klay)
//                .setFrom(account.getAddress())
//                .setTo(Config.getFeePayerAddress())
//                .setValue(value)
//                .setGas(BigInteger.valueOf(25000))
//                .build();
//
//        valueTransfer = (ValueTransfer)caver.wallet.sign(account.getAddress(), valueTransfer);
//        Bytes32 txHashRes = caver.rpc.klay.sendRawTransaction(valueTransfer).send();
//        PollingTransactionReceiptProcessor receiptProcessor = new PollingTransactionReceiptProcessor(caver, 1000, 15);
//        TransactionReceipt.TransactionReceiptData result = receiptProcessor.waitForTransactionReceipt(txHashRes.getResult());
//
//        assertNotNull(result.getTransactionHash());
//    }
//
//    @Test
//    public void fdGlobalValueTransfer() throws IOException, ApiException, TransactionException {
//        BigInteger value = new BigInteger(Utils.convertToPeb("1", Utils.KlayUnit.mKLAY));
//
//        FeeDelegatedValueTransfer feeDelegatedValueTransfer = new FeeDelegatedValueTransfer.Builder()
//                .setKlaytnCall(caver.rpc.klay)
...
//                .build();
//
//        caver.wallet.sign(account.getAddress(), feeDelegatedValueTransfer);
//        caver.wallet.signAsGlobalFeePayer(feeDelegatedValueTransfer);
//        Bytes32 txHashRes = caver.rpc.klay.sendRawTransaction(feeDelegatedValueTransfer).send();
//
//        PollingTransactionReceiptProcessor receiptProcessor = new PollingTransactionReceiptProcessor(caver, 1000, 15);
//        TransactionReceipt.TransactionReceiptData result = receiptProcessor.waitForTransactionReceipt(txHashRes.getResult());
//
...
//
//    @Test
//    public void fdUserValueTransfer() throws ApiException, IOException, TransactionException {
//        BigInteger value = new BigInteger(Utils.convertToPeb("1", Utils.KlayUnit.mKLAY));
//
//        FeeDelegatedValueTransfer feeDelegatedValueTransfer = new FeeDelegatedValueTransfer.Builder()
//                .setKlaytnCall(caver.rpc.klay)
//                .setFrom(account.getAddress())
//                .setTo(Config.getFeePayerAddress())
//                .setFeePayer(Config.getFeePayerAddress())
//                .setValue(value)
//                .setGas(BigInteger.valueOf(2500000))
//                .build();
//
//        caver.wallet.sign(account.getAddress(), feeDelegatedValueTransfer);
//        caver.wallet.signAsFeePayer(Config.getFeePayerAddress(), feeDelegatedValueTransfer);
//        Bytes32 txHashRes = caver.rpc.klay.sendRawTransaction(feeDelegatedValueTransfer).send();
//
//        PollingTransactionReceiptProcessor receiptProcessor = new PollingTransactionReceiptProcessor(caver, 1000, 15);
//        TransactionReceipt.TransactionReceiptData result = receiptProcessor.waitForTransactionReceipt(txHashRes.getResult());
...
//
//    @Test
//    public void fdUserValueTransferWithRatio() throws ApiException, IOException, TransactionException {
//        BigInteger value = new BigInteger(Utils.convertToPeb("1", Utils.KlayUnit.mKLAY));
//
//        FeeDelegatedValueTransferWithRatio feeDelegatedValueTransfer = new FeeDelegatedValueTransferWithRatio.Builder()
//                .setKlaytnCall(caver.rpc.klay)
//                .setFrom(account.getAddress())
//                .setTo(Config.getFeePayerAddress())
//                .setFeePayer(Config.getFeePayerAddress())
//                .setValue(value)
//                .setGas(BigInteger.valueOf(2500000))
//                .setFeeRatio(BigInteger.valueOf(50))
//                .build();
//
//        feeDelegatedValueTransfer = (FeeDelegatedValueTransferWithRatio)caver.wallet.signAsFeePayer(Config.getFeePayerAddress(), feeDelegatedValueTransfer);
//        Bytes32 txHashRes = caver.rpc.klay.sendRawTransaction(feeDelegatedValueTransfer).send();
//
//        PollingTransactionReceiptProcessor receiptProcessor = new PollingTransactionReceiptProcessor(caver, 1000, 15);
//        TransactionReceipt.TransactionReceiptData result = receiptProcessor.waitForTransactionReceipt(txHashRes.getResult());
...
//
//    @Test
//    public void contractDeploy() throws Exception {
//        KIP17 kip17 = KIP17.deploy(caver, account.getAddress(), "KIP17_TEST", "KIP17");
//        assertNotNull(kip17.getContractAddress());
//
//        assertEquals("KIP17_TEST", kip17.name());
//    }
//
//    @Test
//    public void mint() throws Exception {
//        KIP17 kip17 = KIP17.deploy(caver, account.getAddress(), "KIP17_TEST", "KIP17");
//        TransactionReceipt.TransactionReceiptData receiptData = kip17.mint(account.getAddress(), BigInteger.valueOf(2), new SendOptions(account.getAddress(), (String)null));
//
//        assertNotNull(receiptData.getTransactionHash());
//    }
}